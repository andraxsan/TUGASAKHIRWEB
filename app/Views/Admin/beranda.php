    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Card: Sistem Pembelajaran Online -->
                <div class="container mt-5 mb-5 d-flex justify-content-center">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card bg-primary text-white text-center shadow-lg p-5"
                                style="border-radius: 10px;">
                                <h1 class="font-weight-bold">SISTEM PEMBELAJARAN ONLINE</h1>
                                <h2 class="font-weight-bold">SMANSAPRI</h2>
                                <h3 id="currentTimeBlue">--:--:--</h3>
                            </div>
                        </div>
                    </div>
                </div>
