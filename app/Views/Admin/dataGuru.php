...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#" class="btn btn-sm btn-danger btn-hapus"
                                                            data-nip="<?= $g['nip']; ?>" data-toggle="modal"
                                                            data-target="#Hapus-Guru-Modal">
                                                            Hapus
                                                        </a>

                                                        <!-- Tampilkan detail dengan menggunakan data dari tabel -->
                                                        <button class="btn btn-info btn-sm btn-detail-guru"
                                                            data-nip="<?= $g['nip']; ?>" data-nama="<?= $g['nama_guru']; ?>"
                                                            data-alamat="<?= $g['alamat']; ?>"
                                                            data-email="<?= $g['email']; ?>"
                                                            data-foto="<?= base_url('uploads/guru/' . $g['foto']); ?>"
                                                            data-toggle="modal" data-target="#Detail-Guru-Modal">
                                                            Detail
                                                        </button>
                                                    </td>
                                                </tr>
                    ...
                    <!-- Modal Detail Guru -->
                    <div class="modal fade" id="Detail-Guru-Modal" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="text-center">
                                        <img id="foto-guru" src="" alt="Foto Guru" class="img-fluid rounded mb-3"
                    ...
                    <script>
                        ...
                        $('#Detail-Guru-Modal').on('show.bs.modal', function (event) {
        ...
        <!-- The Modal -->
        <div class="modal fade" id="Tambah-Guru-Modal">
        ...
        <div class="modal fade" id="Hapus-Guru-Modal" tabindex="-1" role="dialog" aria-labelledby="HapusModalLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <!-- Modal Header -->
                    ...
                    <div class="modal-footer">
                        ...
                        <form action="<?= base_url('Admin/hapusGuru') ?>" method="POST">
